...
def get_maintenance_centers(request):
    if request.method == 'GET':
        ...
        maintenance_centers_serializer = MaintenanceCenterSerializer(
            maintenance_centers, many=True)
...
def edit_maintenance_center(request, pk):
    ...
    if request.method == 'PUT' and request.user.is_authenticated:
        serializer = EditMaintenanceCenterSerializer(
            instance=maintenance_center, data=request.data)
...
def delete_maintenance_center(request, pk):
    ...
    if request.method == 'GET':
        maintenance_center_serializer = MaintenanceCenterSerializer(
            maintenance_center)
